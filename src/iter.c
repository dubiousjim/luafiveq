/* 
 * iter.c: part of fiveqplus libraries
 *
 * singles sequences are single-element only (like the ones generated by io.lines).
 *    singles{10,20,30} ~~> 1; 2; 3
 *    singles{alpha=true,beta=true,gamma=true} ~~> alpha; beta; gamma
 *
 * 1. singles(obj, [factory=pairs]) honors __singles
...
static int luaIter_iter (lua_State *L) {
    if (luaL_getmetafield(L, 1, "__singles")) {
